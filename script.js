  ...
  if (animatedElements.length > 0) {
    ...
    animatedElements.forEach(function (el, index) {
      ...
      if (delay) {
        ...
        const staggerIndex = parseInt(el.getAttribute('data-stagger-index'), 10) || index;
    ...
    if ('IntersectionObserver' in window) {
      ...
      const checkVisibilityFallback = function () {
...
(function() {
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            var payload = {
                websiteId: '6959e37f-fb60-48ee-9b1a-ebe87b2c5004',
                name: resolvedName,
                email: resolvedEmail,
            ...
            if (result.success) {
                ...
                if (result.thankYouPagePath && result.ticketNumber) {
                    ...
                    if (isPreview && window.ZAPPY_CONFIG) {
                        var wid = window.ZAPPY_CONFIG.websiteId || '6959e37f-fb60-48ee-9b1a-ebe87b2c5004';
...
(function(){
  try {
    ...
    document.addEventListener('submit', function(e) {
      ...
      var wid = '6959e37f-fb60-48ee-9b1a-ebe87b2c5004';
